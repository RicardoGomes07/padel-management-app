...
function getUserRentalsView(contentHeader, content, rentalsResponse, userId, baseLink, skip, limit) {
    ...
    const navigation = createPaginationLinks("users/" + userId + "/rentals", Number(skip), Number(limit), maxNumOfElems)
